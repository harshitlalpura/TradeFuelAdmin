...
import SubscriptionPlans from "../views/custom/Subscriptions/SubscriptionPlans";
import ManageSubscriptionPlan from "../views/custom/Subscriptions/ManageSubscriptionPlan";
import Transactions from "../views/custom/Transactions/Transactions";
import PaymentGateway from "../views/custom/SystemSettings/PaymentGateway";
import StockMarketAPI from "../views/custom/SystemSettings/StockMarketAPI";
import ContactSettings from "../views/custom/SystemSettings/ContactSettings";
import MaintainanceSettings from "../views/custom/SystemSettings/MaintenanceSettings";
import Feedbacks from "../views/custom/Feedbacks/Feedbacks";
import Banner from "../views/custom/Banners/banner";
import Banners from "../views/custom/Banners/Banners";
import Admins from "../views/custom/Admins/Admins";
import Notifications from "../views/custom/Notifications/Notifications";
...
var dashRoutes = [
    ...
    {
        path: "#", name: "Subscriptions", icon: "layers", type: "dropdown", parentid: "multipurpose",
        child: [
            {path: BASEDIR + "/subscriptions", name: "Subscriptions"},
            {path: BASEDIR + "/plans", name: "Subscription Plans"},


        ]
    },

    {path: BASEDIR + "/subscriptions", component: Subscriptions, type: "child"},
    {path: BASEDIR + "/plans", component: SubscriptionPlans, type: "child"},


    {path: BASEDIR + "/transactions", name: "Transactions", icon: "wallet", component: Transactions},

    //{ path: "#", name: "Applications", type: "navgroup"},
    /* {path: BASEDIR + "/transactions", name: "Transactions", icon: "wallet", component: Calendar},*/
    {path: BASEDIR + "/feedbacks", name: "Feedbacks", icon: "bubble", component: Feedbacks},
    {path: BASEDIR + "/banners", name: "Banners", icon: "screen-smartphone", component: Banners},
    {path: BASEDIR + "/notifications", name: "Notifications", icon: "envelope", component: Notifications},
    {path: BASEDIR + "/news", name: "News", icon: "book-open", component: News},
...

    {
        ...
        child: [
            {path: BASEDIR + "/settings/paymentgateway", name: "Payment Gateway"},
    ...
    {path: BASEDIR + "/settings/paymentgateway", component: PaymentGateway, type: "child"},
