...
const header = [
  ...
  {
    title: "Sent To",
    prop: "notification_group",
    sortable: true,
    filterable: true,
  },
  {
    title: "Scheduled",
    prop: "notification_scheduled",
    sortable: true,
    filterable: true,
  },
  {
    title: "Date/Time",
    prop: "notification_datetime",
    sortable: true,
    filterable: true,
  },
...
const DeleteButton = (row) => (
  <Button
    ...
    onClick={() => alert(`Clicked row with ID: ${row.id}`)}
  >
...
class Notifications extends React.Component {
  ...
  fetchNotification = (notification_id) => {
    ...
    makeProtectedRequest("/fetchNotification", "POST", {
      ...
      .then((response) => {
        ...
        if (response.success) {
          ...
          this.setState({
            notificationImage: "/uploads/" + notification.notification_image,
          });
  ...
  deleteNotification = (notification_id) => {
    try {
      makeProtectedRequest("/deleteNotification", "POST", {
        notification_id: notification_id,
      })
        .then((response) => {
          // Handle successful response
                  ...
                  <div className="content-body">
                    <div className="row">
                      <div className="col-lg-12 dt-disp">
                        <Datatable
                          tableHeader={header}
                          tableBody={this.state.notifications.map(
                            (row, index) => ({
                              ...row,
                              notification_no: index + 1,
                              notification_group: row.notification_group
                                ? row.notification_group.notification_group_name
                                : "All",
                              notification_scheduled: row.notification_scheduled
                                ? "Yes"
                                : "No",
                              ...
                              view: (
                                <Button
                                  onClick={() =>
                                    this.fetchNotification(`${row._id}`)
                                  }
                                  className="btn btn-primary btn-sm"
                                >
                              ...
                              delete: (
                                <Button
                                  className="btn btn-primary btn-sm"
                                  onClick={() =>
                                    this.deleteNotification(`${row._id}`)
                                  }
                                >
                                  <i className="fa fa-trash"></i>
                                </Button>
                          ...
                          keyName="userTable"
                          tableClass="striped notificationTable table-hover table-responsive"
                          rowsPerPage={20}
                          rowsPerPageOption={[5, 10, 15, 20]}
                          initialSort={{
                            prop: "notification_no",
                            isAscending: true,
                          }}
        ...
        >
          ...
          <ModalBody>
            <div
              className="row"
              style={
                this.state.mode === "view" ? { pointerEvents: "none" } : {}
              }
            >
                    ...
                    <Form>
                      ...
                      <FormGroup>
                        ...
                        <Input
                          ...
                          invalid={
                            ...
                            touched.notification_type
                          }
                        >
                          <option value={"A"}>App</option>
                          <option value={"S"}>Stock</option>
                        </Input>
                        {errors.notification_group &&
                        touched.notification_group ? (
                          <FormFeedback>
                            {errors.notification_group}
                          </FormFeedback>
                        ) : null}
                      ...
                      <FormGroup>
                        ...
                        <div className="uprofile-image col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12 mb-2 pl-0">
                          <img
                            alt=""
                            src={this.state.notificationImage}
                            className="img-fluid"
                          />
                        </div>
                        <Input
                      ...
                      <FormGroup>
                        <Label htmlFor="notification_group">
                          Notification Group
                        </Label>
                        <Input
                          type="select"
                        ...
                        >
                          ...
                          {this.state.notificationGroups.map(
                            (notificationGroup, index) => (
                      ...
                      <FormGroup>
                        <Label htmlFor="notification_scheduled">
                          Scheduled
                        </Label>
                        <Input
                          type="select"
                          ...
                          placeholder=""
                          invalid={
                            errors.notification_scheduled &&
                            touched.notification_scheduled
                          }
                        >
                      ...
                      {values.notification_scheduled && (
                        <FormGroup>
                          <Label htmlFor="notification_datetime">
                            Scheduled Date/Time
                          </Label>
                          <Input
                            type="datetime-local"
                            ...
                            placeholder=""
                            invalid={
                              errors.notification_datetime &&
                              touched.notification_datetime
                            }
                          />
                          {errors.notification_datetime &&
                          touched.notification_datetime ? (
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                >
                  {({
                    ...
                    <Form>
                      <FormGroup>
                        <Label htmlFor="notification_group_name">
                          Group Name
                        </Label>
                        <Input
                          type="text"
                          ...
                          invalid={
                            errors.notification_group_name &&
                            touched.notification_group_name
                          }
                        />
                        {errors.notification_group_name &&
                        touched.notification_group_name ? (
