            ...
            <Col xs={12} md={12}>
              <div className="page-title">
                ...
                <div className="float-right">
                  <Link className="btn btn-primary btn-sm mt-3" to="/admin">
                    Create Admin
                  </Link>
                </div>
              </div>
                    ...
                    <div className="row">
                      <div className="col-lg-12 dt-disp">
                        <Datatable
                          ...
                          tableBody={admins.map((row, index) => ({
                            ...
                            view: (
                              <Button
                                ...
                                onClick={() => this.openAdmin(`${row._id}`)}
                              >
                            ...
                            delete: (
                              <Button
                                className="btn btn-primary btn-sm"
                                onClick={() => this.deleteAdmin(`${row._id}`)}
                              >
                          ...
                          keyName="userTable"
                          tableClass="striped adminTable table-hover table-responsive"
                          rowsPerPage={20}
