...
const header = [
    ...
    {title: 'Position', prop: 'banner_position', sortable: true, filterable: true},
    {title: 'Active Since', prop: 'banner_created_at', sortable: true, filterable: true},
    {title: 'Expires', prop: 'banner_expires_at', sortable: true, filterable: true},
                                                ...
                                                <Datatable
                                                    ...
                                                    tableBody={banners.map((row,index) => ({
                                                        ...
                                                        delete: <Button className="btn btn-primary btn-sm"
                                                                        onClick={() => this.deleteBanner(`${row._id}`)}><i
