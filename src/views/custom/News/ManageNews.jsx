...
import {
    ...
    Row, Col, DropdownToggle, DropdownMenu, DropdownItem, textarea,
} from 'reactstrap';
...
import {convertFromRaw, convertToRaw, EditorState,convertFromHTML} from "draft-js";
...
class ManageNews extends React.Component {
    ...
    saveNews = (values) => {
        ...
        values.news_body=draftToHtml(convertToRaw(this.state.editorState.getCurrentContent()));
    ...
    render() {
        ...
        const {news, mode, isOpen, newsImage,editorState,contentState} = this.state;
                        ...
                        <Col xs={12} md={12}>
                            ...
                            <div className="page-title">
                                <div className="float-left">
                                    <h1 className="title">{mode === "create" ? "Create News" : "Edit News"}</h1>
                                </div>
                            </div>
                                                        ...
                                                        <Form>
                                                            ...
                                                            <FormGroup>
                                                                ...
                                                                <Input type="text" name="news_title" id="news_title"
                                                                       ...
                                                                       placeholder=""
                                                                       invalid={errors.news_title && touched.news_title}
                                                                />
                                                                {errors.news_title && touched.news_title ? (
                                                                    <FormFeedback>{errors.news_title}</FormFeedback>) : null}
                                                            </FormGroup>
                                                            ...
                                                            <FormGroup>
                                                                ...
                                                                <Input type="text" name="news_author" id="news_author"
                                                                       ...
                                                                       placeholder=""
                                                                       invalid={errors.news_author && touched.news_author}
                                                                />
                                                                {errors.news_author && touched.news_author ? (
                                                                    <FormFeedback>{errors.news_author}</FormFeedback>) : null}
                                                            </FormGroup>


                                                            <FormGroup>
                                                                <Label htmlFor="news_video">Youtube Video URL</Label>
                                                                <Input type="text" name="news_video"
                                                                       id="news_video"
                                                                       onChange={handleChange}
                                                                       value={values.news_video}
                                                                       placeholder=""
                                                                       invalid={errors.news_video && touched.news_video}/>
                                                                {errors.news_video && touched.news_video ? (
                                                                    <FormFeedback>{errors.news_video}</FormFeedback>) : null}
