              ...
              <div className="page-title">
                ...
                <div className="float-right">
                  <Link
                    ...
                    to="/managelearn"
                    onClick={() => localStorage.removeItem("learnId")}
                  >
                    Create Learn
                  </Link>
                </div>
                    ...
                    <div className="row">
                      <div className="col-lg-12 dt-disp">
                        <Datatable
                            ...
                            return {
                              ...
                              view: (
                                <Button
                                  ...
                                  onClick={() => this.openLearn(`${row._id}`)}
                                >
                              ...
                              delete: (
                                <Button
                                  className="btn btn-primary btn-sm"
                                  onClick={() => this.deleteLearn(`${row._id}`)}
                                >
                          ...
                          keyName="userTable"
                          tableClass="striped table-learn table-hover table-responsive"
                          rowsPerPage={20}
