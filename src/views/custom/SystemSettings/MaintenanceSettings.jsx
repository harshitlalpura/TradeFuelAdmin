...
class MaintenanceSettings extends React.Component {
    ...
    validationSchema = () => {
        ...
        return Yup.object().shape({
            maintainance_admin: Yup.string(),
            maintainance_app: Yup.string(),
        });
    }
                                                ...
                                                >
                                                    {({
                                                        ...
                                                        <Form>
                                                            ...
                                                            <FormGroup>
                                                                <Label htmlFor="maintainance_admin">Admin Panel
                                                                    Maintenance</Label>
                                                                <Input type="select" name="maintainance_admin"
                                                                       id="maintainance_admin"
                                                                       value={values.maintainance_admin}
                                                            ...
                                                            <FormGroup>
                                                                <Label htmlFor="maintainance_app">Mobile App
                                                                    Maintenance</Label>
                                                                <Input type="select" name="maintainance_app"
                                                                       id="maintainance_app"
                                                                       value={values.maintainance_app}
                                                                       onChange={handleChange}>
                                                                    <option value="off">Off</option>
                                                                    <option value="on">On</option>
