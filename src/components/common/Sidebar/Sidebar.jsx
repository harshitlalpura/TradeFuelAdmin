...
class Sidebar extends React.Component{
    ...
    componentDidMount(){
        ...
        if(this.props.admintype === 'general'){
            this.setState({
                profileposition:localStorage.getItem("admin_department"),
                profileimg:  IMGDIR + '/uploads/'+localStorage.getItem("admin_profile_image"),
                profilename: localStorage.getItem("admin_name")
            });
        ...
        return (
            <div className="sidebar menubar" data-color="black">
                ...
                <div className="logo">
                    ...
                    <NavLink to="/dashboard" className="logo-full">
                            <img src={logofull} alt="react-logo" className="light-logo"/>
                            <img src={logofulldark} alt="react-logo" className="dark-logo"/>
                    </NavLink>
                </div>
